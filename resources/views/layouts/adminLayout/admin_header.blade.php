{{-- Header-part --}}
<div id="header">
  <h1><a href="{{ url('/admin/dashboard') }}">GhanaTrek</a></h1>
</div>
{{-- close-Header-part --}}
...
<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
        <li class=""><a title="" href="javascript:void(0)"><span class="text">Welcome  {{ Session::get('adminDetails')['UserEmail'] }} ({{ Session::get('adminDetails')['Type'] }})</span></a></li>

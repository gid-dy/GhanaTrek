      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ url('/admin/edit-category/'.$categoryDetails->categoryId) }}" name="edit_category" id="edit_category" novalidate="novalidate">
                @csrf
              ...
              <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="hidden" name="current_image" value="{{ $categoryDetails->Imageaddress }}">
                        <input type="file" name="Imageaddress" id="Imageaddress">
                        @if(!empty($categoryDetails->Imageaddress))
                            <img style= "width: 70px;"  src="{{ asset('images/backend_images/categories/large/'.$categoryDetails->Imageaddress) }}"> | <a href="{{ url('/admin/delete-category-image/'.$categoryDetails->categoryId) }}">Delete</a>
                        @endif
                    </div>
                </div>
                <div class="control-group">

...
<section class="accordion-section clearfix mt-3" aria-label="Question Accordions">
  ...
  <svg width="35" height="9" xmlns="http://www.w3.org/2000/svg"><path d="M1 7l5.5-5L12 7l5.5-5L23 7l5.5-5L34 7" stroke="#f53" stroke-width="3" fill="none" fill-rule="evenodd"></path></svg>
      ...
      <div class="extra">
          <h2>Still needs help </h2>
          <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
              <div class="panel panel-default">
                <div class="panel-heading p-3 mb-3" role="tab" id="heading011">
                  <h3 class="panel-title">
                    <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#collapse011" aria-expanded="true" aria-controls="collapse011">
                    <i class="fa fa-envelope"> Send an email</i>
                    </a>
                  </h3>
                </div>
                  ...
                  <div class="card">
                        <div class="card-body">
                          <form class="form-horizontal" method="post" action="#">
                                <p class="h4 text-center">Get in touch with us</p>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="cols-sm-10">
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="username" id="username"  placeholder="Enter your mobile number"/>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-xl-12">
              ...
              <div class="panel panel-default">
                <div class="panel-heading p-3 mb-3" role="tab" id="heading1">
                <h3 class="panel-title">
                  <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#collapse111" aria-expanded="true" aria-controls="collapse1">
                  <i class="fa fa-whatsapp"> Message us on Whatsapp</i>
                  </a>
                </h3>
                </div>
                <div id="collapse111" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading1">
                <div class="panel-body px-3 mb-4">
                  <p> We currently support chat only</p>
                  <span>+233     542500499</span>
                </div>
                </div>
              </div>
